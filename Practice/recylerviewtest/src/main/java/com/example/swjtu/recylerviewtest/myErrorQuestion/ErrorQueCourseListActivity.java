...
import com.example.swjtu.recylerviewtest.adapter.ErrorQuesCourseRecyclerAdapter;
...
public class ErrorQueCourseListActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_error_que_course);
        initViews();
        initData();
    }
    ...
    private void initData() {
        ...
        ErrorQuesCourseRecyclerAdapter myCourseRecyclerAdapter = new ErrorQuesCourseRecyclerAdapter(courseList);
