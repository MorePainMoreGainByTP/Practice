...
import com.example.swjtu.recylerviewtest.adapter.ReplyMeRecyclerAdapter;
...
public class ReplyMeFragment extends Fragment {

    private ArrayList<DiscussTopic> topicList;

    private SwipeRefreshLayout swipeRefreshLayout;
    private RecyclerView recyclerView;
    private ReplyMeRecyclerAdapter replyMeRecyclerAdapter;

    private static String KEY_MY_TOPIC = "my_topic";

    public static ReplyMeFragment newInstance(ArrayList<DiscussTopic> infos) {
    ...
    private void initData() {
        replyMeRecyclerAdapter = new ReplyMeRecyclerAdapter(topicList);
        recyclerView.setAdapter(replyMeRecyclerAdapter);
    }
