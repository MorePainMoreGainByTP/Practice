...
public class CourseSectionRecyclerAdapter extends RecyclerView.Adapter<CourseSectionRecyclerAdapter.ViewHolder> {

    private List<CourseSection> courseSections;
    private Context context;

    public CourseSectionRecyclerAdapter(List<CourseSection> courseSections) {
        this.courseSections = courseSections;
    }

    @Override
    public CourseSectionRecyclerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (context == null)
    ...
    //每次item进入屏幕时 调用
    @Override
    public void onBindViewHolder(CourseSectionRecyclerAdapter.ViewHolder holder, int position) {
        ...
        holder.resList.setAdapter(new CourseResTypeRecyclerAdapter(courseResources));
    }
