...
import com.example.swjtu.recylerviewtest.adapter.CourseSectionRecyclerAdapter;
...
public class CourseResourceFragment extends Fragment {
    ...
    private ArrayList<CourseSection> courseSectionArrayList;
    public static final String COURSE_SECTION = "courseSection";

    public static CourseResourceFragment newInstance(ArrayList<CourseSection> list) {
    ...
    private void initData() {
        courseSectionArrayList = (ArrayList<CourseSection>) getArguments().getSerializable(COURSE_SECTION);
        recyclerView.setAdapter(new CourseSectionRecyclerAdapter(courseSectionArrayList));
    }
